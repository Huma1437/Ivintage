...
public class VivaExam extends Activity {
    ...
    final static String viva_questions = "http://ivintage.in/PMKVY2/assessor/assessor_api/get_viva_questions";

    final static String viva_submission = "http://ivintage.in/PMKVY2/assessor/assessor_api/submit_vivamarks";
