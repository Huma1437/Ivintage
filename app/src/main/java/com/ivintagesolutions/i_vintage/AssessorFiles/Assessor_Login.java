...
import com.ivintagesolutions.i_vintage.StudentFiles.MainActivity;
...
public class Assessor_Login extends Activity {
    ...
    final static String Login_url = "http://ivintage.in/PMKVY2/assessor/assessor_api/validate_assessor_login";
