...
public class Update_Batch_Status extends Activity implements AdapterView.OnItemSelectedListener {
    ...
    final static String update_batch_status = "http://ivintage.in/PMKVY2/assessor/assessor_api/update_assessment_status";

    final static String check_status = "http://ivintage.in/PMKVY2/assessor/assessor_api/get_tb_assessment_status";
