...
public class ViewPaletteFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       /* getans = (TextView)RootView.findViewById(R.id.get_ans);
        getmark = (TextView) RootView.findViewById(R.id.get_marked);
        getnattend = (TextView) RootView.findViewById(R.id.get_notattend);*/
        ...
        /*getans.setText(getArgument1);
        getmark.setText(getArgument4);
        getnattend.setText(getArgument2);*/
    ...
    //Oflfine Working>>>>>>>>>>>>>>>>>....
    private void QuesFromdatabase() {
        mydb = new DBHelper(getContext());

        Cursor data1 = mydb.getSingleStudentQns(Splash_Screen.sh.getString("student_id", null));
        ...
        if (data1 != null) {
            while (data1.moveToNext()) {
                ...
                Not_Answered.add(Db_na);
                Mark_for_Review.add(Db_review);
                Not_Visited.add(Db_nv);
                ...
                Log.e("DB MAInMethod", ">>>>>>>>>" + "Student id:" + Db_stdID + " " + Db_nosID + Db_nosCode + " " +
