...
public class MainActivity extends Activity {
    ...
    TextView logout,batchid,jobrole,tb_nsdc,enrolnum,stdname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  batchid = (TextView)findViewById(R.id.batchid);
        ...
        tb_nsdc = (TextView)findViewById(R.id.tbnsdc);*/
       ...
       /* tb_nsdc.setText("Batch ID : " + tb_nsdcID );
        batchid.setText("Batch Name : " + batchName);
        jobrole.setText("Job Role : " + jobRole);*/
